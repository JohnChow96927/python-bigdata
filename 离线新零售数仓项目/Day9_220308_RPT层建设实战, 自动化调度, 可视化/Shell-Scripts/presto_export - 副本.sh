...
${MYSQL_HOME} -h172.17.0.203 -p3306 -uroot -p123456 -Dyipin_20210903 -e "
...
drop table if exists yp_olap.rpt_goods_favor_topn;
drop table if exists yp_olap.rpt_goods_cart_topn;
drop table if exists yp_olap.rpt_goods_refund_topn;
...
dim_date_id varchar COMMENT '日期',
order_cnt BIGINT COMMENT '成交单量',
order_turnover DECIMAL(38,2) COMMENT '成交额度',
miniapp_order_cnt BIGINT COMMENT '小程序成交单量',
miniapp_order_turnover DECIMAL(38,2) COMMENT '小程序成交额',
miniapp_order_ratio DECIMAL(38,4) COMMENT '小程序成交量占比',
android_order_cnt BIGINT COMMENT '安卓APP订单量',
android_order_turnover DECIMAL(38,2) COMMENT '安卓APP成交额',
android_order_ratio DECIMAL(38,4) COMMENT '安卓APP订单量占比',
ios_order_cnt BIGINT COMMENT '苹果APP订单量',
ios_order_turnover DECIMAL(38,2) COMMENT '苹果APP成交额',
ios_order_ratio DECIMAL(38,4) COMMENT '苹果APP订单量占比',
pcweb_order_cnt BIGINT COMMENT 'PC商城成交单量',
pcweb_order_turnover DECIMAL(38,2) COMMENT 'PC商城成交额',
...
CREATE TABLE if not exists mysql.yp_olap.rpt_goods_favor_topn(
  sku_id varchar COMMENT '商品ID',
  sku_name varchar COMMENT '商品名称',
...
CREATE TABLE if not exists mysql.yp_olap.rpt_goods_cart_topn(
  sku_id varchar COMMENT '商品ID',
  sku_name varchar COMMENT '商品名称',
...
CREATE TABLE if not exists mysql.yp_olap.rpt_goods_refund_topn(
  sku_id varchar COMMENT '商品ID',
  sku_name varchar COMMENT '商品名称',
