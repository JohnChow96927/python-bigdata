...
# 导入读Oracle表、建Hive表的包
from auto_create_hive_table.cn.itcast.datatohive import CHiveTableFromOracleTable, CreateMetaCommon, \
    CreateHiveTablePartition, LoadData2DWD
...
if __name__ == '__main__':
    ...
    tableList = FileUtil.readFileContent(
        "C:\\GitHub Desktop\\ITheima_python_bigdata\\OneMake_Spark\\dw\\ods\\meta_data\\tablenames.txt")
