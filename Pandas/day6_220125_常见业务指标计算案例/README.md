...
2. ## Pandas计算指标案例
    ...
    1. ### 导入模块&加载数据
        ...
        ![img](../../../../../../../images/chapter08-04.png)

        ```
        data.info()
        ```

        ![img](../../../../../../../images/chapter08-05.png)
    ...
    2. ### 数据清洗
        ...
        ![img](../../../../../../../images/chapter08-06.png)

        ```python
        retail_data['购买时间'].describe(datetime_is_numeric=True)
        ```

        ![img](../../../../../../../images/chapter08-07.png)
        ...
        ```python
        # 过滤长度<5的内容
        retail_data_clean[retail_data_clean.StockCode.str.len().fillna(5)<5]['商品编号'].unique()
        ```

        ![img](../../../../../../../images/chapter08-12.png)

        ```python
        # 过滤长度>6的内容
        retail_data_clean[retail_data_clean.StockCode.str.len().fillna(5)>6]['商品编号'].unique()
        ```

        ![img](../../../../../../../images/chapter08-13.png)
    ...
    7. ### 新用户占比
        ...
        **区分新老用户**
        ...
        retail_data_clean.loc[retail_data_clean['购买年月']>retail_data_clean['首次购买年月'], 
                              '用户类型'] = '老用户'
        retail_data_clean['用户类型'].value_counts()
        ```

        ![img](../../../../../../../images/chapter08-28.png)

        ```python
        retail_data_clean
        ```

        ![img](../../../../../../../images/chapter08-29.png)
